...
if ($selectedProgramName !== "") {
  ...
  $sqlAll = "SELECT b.*, p.program_code, p.program_name $progDateCols FROM beneficiaries b JOIN programs p ON b.program_id = p.program_id WHERE p.program_name = ? AND b.approval_status = 'Approved'";
...
<head>
  ...
  <link rel="stylesheet" href="admin_beneficiaries.css?v=20260910-status-report-ui">
...
<link rel="stylesheet" href="admin_responsive.css?v=22">
