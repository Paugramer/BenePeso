  ...
  <main class="main-area">
    ...
    <div class="workload-modal" id="barangayWorkloadModal" aria-hidden="true">
      ...
      <section class="workload-modal-dialog" role="dialog" aria-modal="true" aria-labelledby="workloadModalTitle">
        ...
        <footer class="workload-modal-foot"><span><i class="ph ph-info"></i> Preview limited to 5 records.</span><a href="admin_beneficiaries.php">Open beneficiary directory <i class="ph ph-arrow-right"></i></a></footer>
      </section>
    </div>
              ...
              <?php else: ?>
                ...
                ?>
                  <tr class="table-row-animate">
                    <td>
                        <div class="row-title dashboard-program-name"><span class="dashboard-program-icon"><i class="ph <?php echo dashboard_program_icon($program["name"]); ?>"></i></span><?php echo h($program["name"]); ?></div>
